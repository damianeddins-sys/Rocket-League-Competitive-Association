    ...
    <section className="min-h-[70vh] bg-[#f4f7fa] px-5 py-16">
      <div className="mx-auto max-w-3xl">
        ...
        <div className="panel mt-8 p-7">
          ...
          <div className="mt-6 rounded-md bg-blue-50 p-4 text-sm leading-6 text-blue-900">Registration will open when authentication and the production database are connected. No information is being collected on this preview.</div>
          <button disabled className="mt-6 cursor-not-allowed rounded-md bg-slate-300 px-5 py-3 font-bold text-slate-600">Registration opening soon</button>
        </div>
      </div>
    </section>
  );
