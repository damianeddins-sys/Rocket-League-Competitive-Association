export const PUBLIC_NAVIGATION_GROUPS = [
  ...
  },
  {
    ...
    href: "/teams",
    items: [
      { label: "Teams", href: "/teams", description: "Official teams, records, and active rosters" },
      { label: "Franchises", href: "/franchises", description: "Organizations, associated teams, and history" },
...
export const FEATURE_ROUTE_OWNERSHIP = {
  ...
  franchises: { route: "/franchises", component: "FranchisesPage" },
